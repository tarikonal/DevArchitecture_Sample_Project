...
export const USERROUTES: RouteInfo[] = [ 
  //{ path: '/log', title: 'Logs', icon: 'update', class: '', claim: "GetLogDtoQuery" }
  { path: '/campaign', title: 'Campaign', icon: 'update', class: '', claim: "GetCampaignQuery" },
  { path: '/gamer', title: 'Gamer', icon: 'update', class: '', claim: "GetGamerQuery" },
  { path: '/game', title: 'Game', icon: 'update', class: '', claim: "GetGameQuery" }
];
